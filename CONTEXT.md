...
Encuentra los hitos del proyecto en los siguientes archivos:

- [MILESTONE_1.md](./MILESTONE_1.md) — Landing page y formulario de aplicación
- [MILESTONE_2.md](./MILESTONE_2.md) — Modelado de datos, colecciones y validaciones
- [MILESTONE_3.md](./MILESTONE_3.md) — Talent Tracker · Recruitment Pipeline (Next.js)